...
$I(a,c) = log(\frac{2/5}{\frac{3}{5}*\frac{2}{5}}) =$ `r log((2/5)/((3/5)*(2/5)))`    

There are total 5 tokens. "ab" appears in 1 token. "a" appears in 3 tokens and "b" appears in 3 tokens.
$I(a,c) = log(\frac{1/5}{\frac{3}{5}*\frac{2}{5}}) =$ `r log((1/5)/((3/5)*(3/5)))`    
...
> In out case this is achieved by sorting dataframe by word/token before casting to sparse matrix.
